...
const { PlatformRuntimeStateV7 } = require('./platformRuntimeStateV7');
...
async function main(){
  ...
  console.log('Intelligence: register inference + polling cycles + fingerprints + relationships + anomaly engine');
  ...
  const state=new PlatformRuntimeStateV7({historyLimit:options.historyLimit});
